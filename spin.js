...
var ASM_CONSTS = {
  92904: () => { if (document.fullscreenElement) return 1; },  
 92950: () => { return Module.canvas.width; },  
 92982: () => { return parseInt(Module.canvas.style.width); },  
 ...
 93176: () => { return Module.canvas.width; },  
 93208: () => { return screen.width; },  
 93233: () => { document.exitFullscreen(); },  
 93260: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93393: () => { return window.innerWidth; },  
 93419: () => { return window.innerHeight; },  
 93446: () => { if (document.fullscreenElement) return 1; },  
 93492: () => { return Module.canvas.width; },  
 93524: () => { return parseInt(Module.canvas.style.width); },  
 93572: () => { if (document.fullscreenElement) return 1; },  
 93618: () => { return Module.canvas.width; },  
 93650: () => { return screen.width; },  
 93675: () => { return window.innerWidth; },  
 93701: () => { return window.innerHeight; },  
 93728: () => { if (document.fullscreenElement) return 1; },  
 93774: () => { return Module.canvas.width; },  
 93806: () => { return screen.width; },  
 93831: () => { document.exitFullscreen(); },  
 93858: () => { if (document.fullscreenElement) return 1; },  
 93904: () => { return Module.canvas.width; },  
 93936: () => { return parseInt(Module.canvas.style.width); },  
 93984: () => { document.exitFullscreen(); },  
 94011: ($0) => { Module.canvas.style.opacity = $0; },  
 94049: () => { return screen.width; },  
 94074: () => { return screen.height; },  
 94100: () => { return window.screenX; },  
 94127: () => { return window.screenY; },  
 94154: () => { return window.devicePixelRatio; },  
 94190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94243: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94294: () => { Module.canvas.style.cursor = 'none'; },  
 94331: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94587: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94638: () => { if (document.fullscreenElement) return 1; },  
 94684: () => { return window.innerWidth; },  
 94710: () => { return window.innerHeight; },  
 94737: () => { if (document.pointerLockElement) return 1; }
};
